...
class AlloyDBAdminClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Cluster');
        const createClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const updateClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Cluster');
        const updateClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const deleteClusterResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const promoteClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Cluster');
        const promoteClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const restoreClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Cluster');
        const restoreClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const createSecondaryClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Cluster');
        const createSecondaryClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const createSecondaryInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Instance');
        const createSecondaryInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const batchCreateInstancesResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.BatchCreateInstancesResponse');
        const batchCreateInstancesMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const failoverInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Instance');
        const failoverInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const injectFaultResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Instance');
        const injectFaultMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const restartInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Instance');
        const restartInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const createBackupResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Backup');
        const createBackupMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const updateBackupResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.Backup');
        const updateBackupMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        const deleteBackupResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteBackupMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1beta.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.alloydb.v1beta.AlloyDBAdmin', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.alloyDBAdminStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.alloydb.v1beta.AlloyDBAdmin')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.alloydb.v1beta.AlloyDBAdmin, this._opts, this._providedCustomServicePath);
