...
os.environ["DG_API_KEY"] = "dcbc3f4cdee4766ffe7446c940293256b2e3aef3"


# kyomoto
# dcbc3f4cdee4766ffe7446c940293256b2e3aef3

load_dotenv()

class LanguageModelProcessor:
    def __init__(self):
        self.llm = ChatGroq(temperature=0, model_name=MODEL, groq_api_key=os.getenv("GROQ_API_KEY"))
...
class TextToSpeech:
    ...
    DG_API_KEY = "dcbc3f4cdee4766ffe7446c940293256b2e3aef3"
