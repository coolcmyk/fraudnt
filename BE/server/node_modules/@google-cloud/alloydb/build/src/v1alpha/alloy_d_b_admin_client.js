...
class AlloyDBAdminClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            databasePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/clusters/{cluster}/databases/{database}'),
        ...
        const createClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Cluster');
        const createClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const updateClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Cluster');
        const updateClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const deleteClusterResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const promoteClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Cluster');
        const promoteClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const restoreClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Cluster');
        const restoreClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const createSecondaryClusterResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Cluster');
        const createSecondaryClusterMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const createSecondaryInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Instance');
        const createSecondaryInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const batchCreateInstancesResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.BatchCreateInstancesResponse');
        const batchCreateInstancesMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const failoverInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Instance');
        const failoverInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const injectFaultResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Instance');
        const injectFaultMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const restartInstanceResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Instance');
        const restartInstanceMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const createBackupResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Backup');
        const createBackupMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const updateBackupResponse = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.Backup');
        const updateBackupMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        const deleteBackupResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteBackupMetadata = protoFilesRoot.lookup('.google.cloud.alloydb.v1alpha.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.alloydb.v1alpha.AlloyDBAdmin', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.alloyDBAdminStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.alloydb.v1alpha.AlloyDBAdmin')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.alloydb.v1alpha.AlloyDBAdmin, this._opts, this._providedCustomServicePath);
